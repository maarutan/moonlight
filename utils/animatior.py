...
class Animator(Service):
    ...
    def bezier_curve(self) -> tuple[float, float, float, float]:  # type: ignore
    ...
    @Property(float, "read-write")
    def max_value(self):  # type: ignore
    ...
    @Property(float, "read-write")
    def min_value(self):  # type: ignore
    ...
    def playing(self):  # type: ignore
        return self._playing

    @playing.setter  # type: ignore
    def playing(self, value: bool):
        self._playing = value
        return

    @Property(bool, "read-write", default_value=False)
    def repeat(self):  # type: ignore
        return self._repeat
