...
# # импортируйте ваш модуль, где лежит NetworkService
# # from network_service_module import NetworkService

# # Для простоты — вставьте сюда ваш класс NetworkService/Wifi/Ethernet
# # (или импортируйте, если у вас в отдельном файле)


# # --- пример обработчика, запускающегося когда устройство готово ---
# def device_ready_handler():
#     primary = network_service.primary_device
#     print("Primary device:", primary)

#     if primary == "wifi" and network_service.wifi_device:
#         wifi = network_service.wifi_device
#         print("Тип: Wi-Fi")
#         print("SSID (active):", wifi.ssid)
#         print("Сила сигнала:", wifi.strength, "%")
#         print("Интернет:", wifi.internet)
#         print("Доступные сети (первые 10):")
#         for ap in wifi.access_points[:10]:
#             print(
#                 f"  SSID: {ap['ssid']!r}, strength: {ap['strength']}%, freq: {ap['frequency']} MHz, bssid: {ap['bssid']}"
#             )

#         # Примеры действий (раскомментируйте, чтобы протестировать)
#         # wifi.scan()                         # запускает скан, сигнал 'scanning' будет эмитирован
#         # success = wifi.connect_network("MySSID", "mypassword", remember=False)
#         # print("connect_network ->", success)
#         # wifi.forget_access_point("MySSID")

#     elif primary == "wired" and network_service.ethernet_device:
#         eth = network_service.ethernet_device
#         print("Тип: Ethernet")
#         print("Скорость:", eth.speed, "Мбит/с")
#         print("Интернет:", eth.internet)
#     else:
#         print("Нет активного устройства или устройство ещё не инициализировано")

#     # если хотите — не останавливайте loop; здесь остановим для демонстрации:
#     loop.quit()
...
# # создаём сервис (Asynchronous init внутри NetworkService запустится сам)
# network_service = NetworkService()

# # подключаем сигнал device_ready
# network_service.device_ready.connect(lambda *_: device_ready_handler())

# print("Ожидание инициализации сети...")
# loop.run()
# print("Завершение.")
