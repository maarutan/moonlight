...
from gi.repository import Gdk, GdkPixbuf, Gtk  # noqa: E402 #type: ignore


class CircleImage(Gtk.DrawingArea, Widget):  # type: ignore
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if image_file:
            ...
            self._image = self._process_image(pix)  # type: ignore
        elif pixbuf:
    ...
    def _process_image(self, pixbuf: GdkPixbuf.Pixbuf) -> GdkPixbuf.Pixbuf:
        ...
        if square_size != self.size:
            pixbuf = pixbuf.scale_simple(  # type: ignore
    ...
    def set_image_from_file(self, new_image_file: str):
        ...
        self._orig_image = pixbuf
        self._image = self._process_image(pixbuf)  # type: ignore
        self.queue_draw()
